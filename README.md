...
- `harness/` — the agent harness. Talks to the Google Gemini API directly
  ...
  state. Scaffolded from
  [fulcra-agent-harness-starter](https://github.com/fulcradynamics/fulcra-community-projects/tree/main/fulcra-agent-harness-starter) —
  see that project's README for how this was generated and how to
...
- `intake/`, `interview/`, `architecture.md`, `plan.md` — artifacts from
  the `fulcra-rapid-prototype` skill's Intake/Interview/Architecture/Plan
