...
Not a unit test suite yet (no pytest, no mocking) — this is a quick, honest
way to prove the adapter actually works end-to-end against the real API
before we build anything on top of it. Run directly:
